...
import {
  ...
  type SolidMeshData,
} from '@/modules/part/kernel/cadEngine';
...
import { arcSignedSweep, sampleArcPoints } from '@/core/sketchArcPoints';
import {
...
import { usePartViewportMode, type PartViewportMode } from '../viewport/partViewportMode';
import {
  C_BASE,
  C_EDGE,
  C_EDGE_HOV,
...
import {
  ...
  type BRepMeshVertex,
  type FacePickData,
  bestMeshEdgeIdForRef,
  bestMeshVertexIdForPointRef,
  buildEdgesFromMesh,
  buildFaceSelectionRef,
  buildFacesFromMesh,
  buildVerticesFromEdges,
  faceRefMatchesMeshFace,
  pointInPoly2D,
  selectionHintObjectLabel,
  signedArea2D,
  tryBrepFaceSelectionRefFromIntersections,
} from '../viewport/viewportBrep';
